...
class CornerNetFocalLoss(nn.Module):
    ...
    def forward(self, inputs, targets):
        ...
        # Positive loss: -(t-p)^α * log(p) , (more canonical formulation uses 1-p for true binary case)
...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        # Paths
        'save_dir': './models/old_labels/parallel_fpn_cornernet_fold0_2',  
        'exist_ok':False,
    ...
    #     print(f"Using mae focal loss with gamma={CONFIG['gamma']}")
        ...
        conf_loss_fn = CornerNetFocalLoss(pos_threshold= CONFIG['pos_threshold'],alpha=CONFIG['alpha'], beta=CONFIG['beta'])
