...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        'train_folds': [0],
        'val_folds' :[],
        'dataset_path':Path('./data/processed/relabeled_patches/'),
        'labels_path' :Path('./data/original_data/RELABELED_DATA.csv'),
        ...
        # Paths
        'save_dir': './models/relabeled_data/parallel_fpn_cornernet_fold0',  
        'exist_ok':True,
