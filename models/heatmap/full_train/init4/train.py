...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\full_train\init3\epoch40.pt'))
    
    save_dir = './models/heatmap/full_train/init4/'
    ...
    optimizer_state = torch.load(
        r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\full_train\init3\epoch40_optimizer.pt', 
        map_location=device
    )
