...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\full_train\init6\best.pt'))
    
    save_dir = './models/heatmap/full_train/init67/'
    ...
    optimizer_state = torch.load(
        r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\full_train\init6\best_optimizer.pt', 
        map_location=device
    )
