...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\curriculum4/run2\best.pt'))
    ...
    save_dir = './models/heatmap/curriculum4/run3/'
    ...
    epochs =10
    lr = 1e-3 / 2#started with 1e-3 for 1//30
    batch_size = 2
    ...
    #     r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\curriculum4/run2\best_optimizer.pt', 
    #     map_location=device
    # )
