...
if __name__ == "__main__":
    ...
    save_dir = './models/heatmap/fpn/dual_skip/'
    ...
    train_loader = DataLoader(train_dataset,sampler = None, batch_size = batch_size, shuffle = False, pin_memory =pin_memory, num_workers=num_workers, persistent_workers= persistent_workers, prefetch_factor= prefetch_factor)
