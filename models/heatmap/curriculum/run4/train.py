...
if __name__ == "__main__":
    ...
    # model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\curriculum\run2\best.pt'))
    ...
    save_dir = './models/heatmap/curriculum/run4/'
    ...
    conf_loss_fn = FocalLoss(alpha = 20, gamma = 1.5)#alpha is pos weight, gamma is focusing param
    ...
    #     r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\curriculum\run2\best_optimizer.pt', 
    #     map_location=device
    # )
