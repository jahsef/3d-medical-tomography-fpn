...
class MotorIdentifier(nn.Module):
    ...
    def inference(self, tomo_tensor, batch_size, patch_size, overlap, device, tqdm_progress:bool):
        ...
        inferer = monai.inferers.inferer.SlidingWindowInferer(
            ...
            mode='gaussian', sigma_scale=1/8, device=device, 
        ...
        # Break computation graph and clone to new tensor
        results_clean = results.detach().clone()
        
        del inferer, sigmoid_model, results
