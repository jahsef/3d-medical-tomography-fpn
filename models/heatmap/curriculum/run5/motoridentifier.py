...
class MotorIdentifier(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nnblock.PreActResBlock3d(FOC//8, FOC//8),
            #c32, 64^3
            nnblock.PreActResBlock3d(FOC//8, FOC//4, stride = 2, kernel_size=3),
            nnblock.PreActResBlock3d(FOC//4, FOC//4),
            #c64, 16^3
            nnblock.PreActResBlock3d(FOC//4, FOC//2, stride = 2, kernel_size=3),
            nnblock.PreActResBlock3d(FOC//2, FOC//2),
            #c128, 8^3
            nnblock.PreActResBlock3d(FOC//2, FOC, stride = 2, kernel_size=3),
            nnblock.PreActResBlock3d(FOC, FOC),
            nnblock.PreActResBlock3d(FOC, FOC),
        )
        ...
        # Classification head
        self.classification_head = nn.Conv3d(FOC//8, 1, kernel_size=3,padding = 1, bias=False)
