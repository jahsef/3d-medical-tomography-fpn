...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\curriculum3/run2\best.pt'))
    ...
    save_dir = './models/heatmap/curriculum3/run3/'
    ...
    conf_loss_fn = FocalLoss(alpha = 5, gamma = 1)#alpha is pos weight, gamma is focusing param
