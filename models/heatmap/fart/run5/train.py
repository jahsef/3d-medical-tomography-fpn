...
class BCETopKLoss(nn.Module):
    ...
    def forward(self, inputs, targets):
        ...
        topk_loss = torch.topk(bce_flat, self.k)[0]
...
if __name__ == "__main__":
    ...
    # model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\fart/run1\best.pt'))
    ...
    save_dir = './models/heatmap/fart/run5/'
    ...
    #     r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\fart/run1\best_optimizer.pt', 
    #     map_location=device
    # )
    ...
    conf_loss_fn = BCETopKLoss(k = 400)
