...
class MotorIdentifier(nn.Module):
    def __init__(self, dropout_p = 0, norm_type = "gn"):
        ...
        nn.SiLU(),
        nn.Conv3d(F_I*2, 32, kernel_size=1)
        )
        ...
        nn.SiLU(),
        nn.Conv3d(F_I*4, 32, kernel_size=1)
        )
        ...
        nn.SiLU(),
        nn.Conv3d(F_I*8, 32, kernel_size=1)
        )
        ...
        nn.SiLU(),
        nn.Conv3d(F_I*16, 32, kernel_size=1)
        )
        ...
        nn.SiLU(),
        nn.Conv3d(F_I*32, 32, kernel_size=1)
        )
