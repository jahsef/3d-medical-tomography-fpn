...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\resnet_backbone/run1/\best.pt'))
    ...
    save_dir = './models/heatmap/resnet_backbone/run2/'
    ...
    blob_sigma = 69 #this is in real coord space not downsampled
