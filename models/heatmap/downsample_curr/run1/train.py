...
if __name__ == "__main__":
    ...
    # model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\fart/run7\epoch4.pt'))
    ...
    save_dir = './models/heatmap/downsample_curr/run1/'
