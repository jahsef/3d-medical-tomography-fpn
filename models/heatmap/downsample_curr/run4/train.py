...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\downsample_curr/run3\best.pt'))
    ...
    save_dir = './models/heatmap/downsample_curr/run4/'
    ...
    conf_loss_fn = BCETopKLoss(k = 1500)
