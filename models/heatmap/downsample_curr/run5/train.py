...
if __name__ == "__main__":
    ...
    train_transform = monai.transforms.Compose([
        ...
        transforms.SpatialPadd(keys = ['patch', 'label'], spatial_size= [136,248,248], mode = 'reflect'),
        transforms.RandSpatialCropd(keys = ['patch', 'label'], roi_size = [128,240,240], random_center=True), 
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\downsample_curr/run4\best.pt'))
    ...
    save_dir = './models/heatmap/downsample_curr/run5/'
    ...
    train_id_list = train_id_list[:len(train_id_list)//15*2]
