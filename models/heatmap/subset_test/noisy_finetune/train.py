...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\subset_test\bigger_pretrain\best.pt'))
    
    save_dir = './models/heatmap/subset_test/noisy_finetune/'
