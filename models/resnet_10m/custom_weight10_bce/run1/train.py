...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        # Loss
        'loss_function': 'weighted_bce',  # 'vanilla_bce', 'weighted_bce', 'focal'
        'pos_weight': 10,
        ...
        # Paths
        'save_dir': './models/resnet_10m/custom_weight10_bce/run1',
        'exist_ok':True,
        ...
        # Example Loss Function Configurations
        '_EXAMPLE_LOSS_CONFIGS': {
            # Standard PyTorch BCE loss
            'vanilla_bce': {
                'loss_function': 'vanilla_bce',
                'pos_weight': None,  # Not used
                'gamma': None,       # Not used
            },
            # Custom weighted BCE with class imbalance handling
            'weighted_bce': {
                'loss_function': 'weighted_bce',
                'pos_weight': 10,    # Weight for positive class
                'gamma': None,       # Not used
            },
            # Custom focal loss for hard example mining
            'focal': {
                'loss_function': 'focal',
                'pos_weight': 10,    # Weight for positive class
