...
from model_defs.cascade_fpn import MotorIdentifier as FPNModel
...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        # Loss
        'loss_function': 'focal',  # 'vanilla_bce', 'weighted_bce', 'focal', 'cornernet'
        ...
        # Paths
        'save_dir': './models/fpn_comparison/new_fpn_focal',  
        'exist_ok':True,
    ...
    if CONFIG['loss_function'] == 'vanilla_bce':
        ...
        conf_loss_fn = FocalLoss(gamma=CONFIG['gamma'])
        print(f"Using focal loss with gamma={CONFIG['gamma']}")
