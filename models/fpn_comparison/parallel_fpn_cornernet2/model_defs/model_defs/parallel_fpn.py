...
class ParallelFPN(nn.Module):
    ...
    def __init__(self, base_features, growth_rate, downchanneling_factor, dropout_p=0, drop_path_p=0):
        ...
        self.head = nn.Sequential(
            ...
            # nnblock.get_norm_layer(norm_type="gn", num_channels=total_concat_channels),#se block takes normed inputs, but we normalize globally so that the scales can be kinda different
