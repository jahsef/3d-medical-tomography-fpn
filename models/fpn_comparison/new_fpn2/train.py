...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        # Paths
        'save_dir': './models/fpn_comparison/new_fpn2',  
        'exist_ok':True,
        ...
        'pretrained': {
            'model_path': './models/fpn_comparison/old_fpn2/weights/best.pt',
            'optimizer_path': './models/fpn_comparison/old_fpn2/weights/best_optimizer.pt',
            'load_optimizer': True,
        },
        'debug_mode': False,
