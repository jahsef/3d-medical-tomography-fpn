...
class MotorIdentifier(nn.Module):
    ...
    def __init__(self, dropout_p=0, norm_type="gn"):
        ...
        FEATURE_PROGRESSION = [16,32,64,128,256]
        ...
        self.head = nn.Sequential(
            nn.Dropout3d(p=self.dropout_p),
            nn.Conv3d(248, 128, kernel_size=1),
            nnblock.get_norm_layer("gn", 128),
            nn.SiLU(inplace=True),
            nnblock.SEBlock3d(128, reduction=4),
            nnblock.PreActResBlock3d(128,64,kernel_size=3),
            nnblock.PreActResBlock3d(64,24,kernel_size=3),
