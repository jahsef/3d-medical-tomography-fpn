...
from model_defs._trivial_model import TrivialModel
...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        # Paths
        'save_dir': './models/trivial_model_test/',
    ...
    model = TrivialModel(dropout_p=CONFIG['dropout_p'], norm_type=CONFIG['norm_type'])
    model.print_params()
