...
if __name__ == "__main__":
    ...
    # model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\strong_aug/small/run1\best.pt'))
    ...
    save_dir = './models/simple_resnet/small/run1'
    ...
    #     r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\strong_aug/small/run1\best_optimizer.pt', 
    #     map_location=device
    # )
    ...
    # conf_loss_fn = BCETopKLoss(k = 450)
