...
if __name__ == "__main__":
    ...
    train_transform = monai.transforms.Compose([
        ...
        transforms.RandRotated(keys=['patch', 'label'], range_x=0.33, range_y=0.33, range_z=0.33, prob=0.3, mode='trilinear'),
        transforms.RandZoomd(keys=['patch', 'label'], min_zoom = 0.9, max_zoom = 1.1, prob = 0.3, mode = 'trilinear'),
    ...
    save_dir = './models/simple_resnet/med/run3'
