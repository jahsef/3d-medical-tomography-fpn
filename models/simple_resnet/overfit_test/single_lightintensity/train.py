...
if __name__ == "__main__":
    ...
    train_transform = monai.transforms.Compose([
        ...
        # transforms.RandGaussianNoised(keys='patch', dtype=torch.float16, prob=0.25, std=0.1),
        transforms.RandShiftIntensityd(keys='patch', offsets=0.1, safe=True, prob=0.25),
        transforms.RandAdjustContrastd(keys="patch", gamma=(0.9, 1.1), prob=0.25),
    ...
    # model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\simple_resnet/overfit_test/single_aug\best.pt'))


    save_dir = './models/simple_resnet/overfit_test/single_lightintensity/'
    ...
    #     r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\simple_resnet/overfit_test/60subset_aug/\best_optimizer.pt', 
    #     map_location=device
    # )
