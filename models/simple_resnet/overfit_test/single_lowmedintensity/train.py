...
if __name__ == "__main__":
    ...
    train_transform = monai.transforms.Compose([
        ...
        transforms.RandGaussianNoised(keys='patch', dtype=torch.float16, prob=0.33, std=0.1),
        transforms.RandShiftIntensityd(keys='patch', offsets=0.1, safe=True, prob=0.33),
        transforms.RandAdjustContrastd(keys="patch", gamma=(0.9, 1.1), prob=0.33),
        transforms.RandScaleIntensityd(keys="patch", factors=0.1, prob=0.33),
    ...
    save_dir = './models/simple_resnet/overfit_test/single_lowmedintensity/'
