...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\simple_resnet/overfit_test/60subset_aug\best.pt'))


    save_dir = './models/simple_resnet/overfit_test/60subset_aug_run2/'
