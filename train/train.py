...
if __name__ == "__main__":
    ...
    # model.load_state_dict(torch.load(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\heatmap\curriculum\run8\best.pt'))
    ...
    train_id_list = train_id_list[:len(train_id_list)//2]
    ...
    optimizer = torch.optim.AdamW([
        {'params': encoder_params, 'lr': lr / 10 },  # 10x lower
