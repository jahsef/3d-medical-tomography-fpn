...
if __name__ == "__main__":
    ...
    CONFIG = {
        ...
        # Loss
        'loss_function': 'mse',  # 'bce', 'mse', 'focal', 'cornernet'
        ...
        # Paths
        'save_dir': './models/fpn_comparison/old_fpn_mse',  
        'exist_ok':True,
    ...
    model = FPNModel(dropout_p=CONFIG['dropout_p'], drop_path_p=CONFIG['drop_path_p'])
