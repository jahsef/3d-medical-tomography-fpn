...
# from models.fpn_comparison.parallel_fpn_bce.motor_detector import MotorDetector
...
MODEL_DIR = Path(r'C:\Users\kevin\Documents\GitHub\kaggle-byu-bacteria-motor-comp\models\fpn_comparison\parallel_fpn_bce')
