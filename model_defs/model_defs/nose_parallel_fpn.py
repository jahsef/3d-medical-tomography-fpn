"""ParallelFPN without SE blocks - for ablation comparison."""
...
class NoSEParallelFPN(nn.Module):
    """ParallelFPN with all SE blocks removed for ablation study."""
    ...
    def __init__(self, base_features, growth_rate, downchanneling_factor, dropout_p=0, drop_path_p=0):
        ...
        # Decoder blocks WITHOUT SE blocks
        ...
        self.head = nn.Sequential(
            ...
            nn.SiLU(inplace=True),
            nn.Conv3d(power_2_rounding(total_concat_channels/8), 1, kernel_size=1, bias=True)
        )
