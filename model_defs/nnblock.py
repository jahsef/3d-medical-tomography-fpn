...
def get_norm_layer(norm_type, num_channels, target_channels_per_group=4):
    if norm_type == "bn3d":
...
class PreActResBlock3d(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1, kernel_size=3, norm_type="bn3d", target_channels_per_group=4):
