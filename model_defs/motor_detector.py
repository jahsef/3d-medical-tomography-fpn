...
def _load_preset(model_name, model_size, dropout_p, drop_path_p):
    ...
    elif model_name == 'pc_fpn':
        preset = PRESETS['pc_fpn'].get(model_size, None)
        if preset is None:
...
if __name__ == "__main__":
    motor_detector = MotorDetector(model_name="cascade_fpn",model_size="4m", dropout_p=0,drop_path_p=0)
    motor_detector.print_params()